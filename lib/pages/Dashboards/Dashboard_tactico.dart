...
class DashBoard_tactico extends StatefulWidget {
  final String juego;
  const DashBoard_tactico(this.juego, {Key? key}) : super(key: key);
  @override
  State<DashBoard_tactico> createState() => _DashboardState();
}

class _DashboardState extends State<DashBoard_tactico>
  ...
  void BestPost() {
    ...
    _listImage = auth.better('tactico');
  }
                        ...
                        if (snapshot.hasData) {
                          return ListView(
                            ...
                            children: [
                              Column(
                                mainAxisSize: MainAxisSize.max,
                                children: _listImageChildren(
                                    snapshot.data, widget.juego),
                              ),
                            ],
                          );
  ...
  List<Widget> _listImageChildren(data, game) {
