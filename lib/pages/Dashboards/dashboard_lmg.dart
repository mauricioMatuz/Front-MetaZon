...
class Dashboard_lmg extends StatefulWidget {
  final String juego;
  const Dashboard_lmg(this.juego, {Key? key}) : super(key: key);
  @override
  State<Dashboard_lmg> createState() => _DashboardState();
}

class _DashboardState extends State<Dashboard_lmg>
