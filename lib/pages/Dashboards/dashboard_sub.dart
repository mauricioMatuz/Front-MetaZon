...
class Dashboard_sub extends StatefulWidget {
  final String juego;
  const Dashboard_sub(this.juego, {Key? key}) : super(key: key);
  @override
  State<Dashboard_sub> createState() => _DashboardState();
}

class _DashboardState extends State<Dashboard_sub>
  ...
  void BestPost() {
    ...
    _listImage = auth.better('subfusil');
  }
